...
3. **Invocation name**: menu *Build → Invocation* → imposta `mia dispensa`
   (minuscolo) → Save. ⚠️ Regole Alexa: minimo 2 parole, e un nome non può contenere
   articoli o preposizioni ("la", "di"…). `mia dispensa` va bene perché "mia" è un
   possessivo (non un articolo).
...
- "apri mia dispensa"
- "chiedi a mia dispensa di aggiungere il latte"
- "chiedi a mia dispensa cosa sta per scadere"
...
- *"Alexa, apri mia dispensa"* poi *"aggiungi il latte"*
- oppure in un colpo solo: *"Alexa, chiedi a mia dispensa di aggiungere il latte"*
- *"Alexa, chiedi a mia dispensa cosa devo comprare"*
